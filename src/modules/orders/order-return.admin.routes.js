...
import {
  ...
  getAdminOrderReturnMetricsTrendController,
...
import {
  ...
  adminOrderReturnMetricsTrendRequestSchema,
...
/*
|--------------------------------------------------------------------------
| Admin Return Operational Metrics Trend
|--------------------------------------------------------------------------
|
| GET
...
router.get(
  ...
  validateRequest(adminOrderReturnMetricsTrendRequestSchema),
